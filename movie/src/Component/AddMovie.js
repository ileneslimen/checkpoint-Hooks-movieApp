    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          />
          <input input className='addinput'
            placeholder="Add the movie director"
            type="text"
            value={Newdir}
      ...
      <Form.File.Input value={setNewImg} onChange={(e) => setNewImg(e.target.value)} />
    </Form.File>
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            onClick={() =>
              Add({ title: NewTitle, Director: Newdir, description: NewDesc, rate: NewRate, img: NewImg})
            }
          >
            Save Changes
          </Button>
